...
int32_t main()
{
    ...
    // app.addComponent(std::make_shared<BreakoutMenu>(), SDL_FRect{0.0f, 0.0f, 0.5f, 0.5f}, true);
    // app.addComponent(std::make_shared<BreakoutMenu>(), SDL_FRect{0.5f, 0.0f, 1.0f, 0.5f}, true);
    // app.addComponent(std::make_shared<BreakoutMenu>(), SDL_FRect{0.0f, 0.5f, 0.5f, 1.0f}, true);
    // app.addComponent(std::make_shared<BreakoutMenu>(), SDL_FRect{0.5f, 0.5f, 1.0f, 1.0f}, true);
